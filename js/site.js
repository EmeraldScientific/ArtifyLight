...
;(function($) {
  ...
  var CLASSES = ($.treeview.classes = {
    ...
    collapsableHitarea: "collapsable-hitarea a",
...
jQuery(function(){ var templink = "";   
  jQuery(document).ready(function(){ jQuery(".lt-ie8 .hitarea").click(function(){ 
    templink  =jQuery(this);  jQuery(templink).parent().next().css("opacity","0"); window.setTimeout(function(){ 
    jQuery(templink).parent().next().css("opacity","0").css("opacity","1");
},500);  }); });
